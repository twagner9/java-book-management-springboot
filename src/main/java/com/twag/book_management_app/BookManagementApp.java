...
// SpringBootApplication Annotation contains the following (info from https://spring.io/guides/gs/spring-boot):
/*
 * 
    ...
    @ComponentScan: Tells Spring to look for other components, configurations, and services in the com/twag package, letting it find the controllers.
...
public class BookManagementApp {
	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			// System.out.println("Configure beans:");
